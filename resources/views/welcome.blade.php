  ...
  <div class="row">
    ...
    <form class="col-md-4 order-md-1 col-lg-3 sidebar-filter">
      ...
      <div class="price-filter-control">
        <input type="number" class="form-control w-50 pull-left mb-2" placeholder="1" name="filter[price_min]" id="price-min-control">
        <input type="number" class="form-control w-50 pull-right" placeholder="200" name="filter[price_max]" id="price-max-control">
      </div>
